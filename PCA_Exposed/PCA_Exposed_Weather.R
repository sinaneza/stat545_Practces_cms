...
saveRDS(Exposed_Weather,"Exposed_Weather.rds")
...
library(ggfortify)
(plot_90 <- autoplot(FS_pca, x= 1, y= 2,
...
# ggsave("C:/additional/UBC/MENG_Papers/PCA/Weather/First90Days/Coatingwise/FC.png", plot_90, scale = 1)
