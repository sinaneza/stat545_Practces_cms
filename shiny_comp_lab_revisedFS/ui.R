...
ui <- fluidPage(
	br(),
	titlePanel("Environmental Effect on Fibre Glass Composites, Lab Samples, Original Data"),
	fluidRow(
		br(), br(),
		column(3,
		...
		column(9,
					 tabsetPanel(
					 	tabPanel("Roughness Scatter Plots",
					 					 br(),
					 					 h2("Lab Samples, Roughness Scatter Plots"),
					 					 br(),
					 	...
					 	tabPanel("Roughness Box Plots", 
					 					 br(),
					 					 h2("Lab Samples, Roughness Box Plots:"),
					 					 br(),
					 	...
					 	tabPanel("Roughness Trends",
					 					 br(),
					 					 h2("Lab Samples, Roughness General Trends:"),
					 					 br(),
					 					 ...
					 					 br(),
					 					 h2("Lab Samples, Gained Roughness:"),
					 					 br(),
					 	...
					 	tabPanel("Roughness Model",
					 					 br(),
					 					 h2("Lab Samples, Roughness Model Trends:"),
					 					 br(),
					 					 ...
					 					 br(), br()
					 					 # h2("Lab Samples, Roughness Gained:"),
					 					 # br(),
					 	...
					 	tabPanel("Hardness Scatter Plots",
					 					 br(),
					 					 h2("Lab Samples, Hardness, Scatter Plots:"),
					 					 br(),
					 	...
					 	tabPanel("Hardness Box Plots",
					 					 br(),
					 					 h2("Lab Samples, Hardness, Box Plots:"),
					 					 br(),
					 	...
					 	tabPanel("Hardness Trends",
					 					 br(),
					 					 h2("Lab Samples, Hardness Average Trends:"),
					 					 br(),
					 					 ...
					 					 br(),
					 					 h2("Lab Samples, Gained Hardness:"),
					 					 br(),
					 	...
					 	tabPanel("Hardness Model",
					 					 br(),
					 					 h2("Lab Samples, Hardness Model Trends:"),
					 					 br(),
					 					 ...
					 					 br(), br()
					 					 # h2("Lab Samples, Hardness Gained:"),
					 					 # br(),
					 	...
					 	tabPanel("Flexural Scatter Plots",
					 					 br(),
					 					 h2("Lab Samples, Flexural Stress Scatter Plots"),
					 					 br(),
					 	...
					 	tabPanel("Flexural Box Plots", 
					 					 br(),
					 					 h2("Lab Samples, Flexural Strength Box Plots:"),
					 					 br(),
					 	...
					 	tabPanel("Flexural Strength Average Trends",
					 					 br(),
					 					 h2("Lab Samples, Flexural Strength, Average Trends:"),
					 					 br(),
					 					 ...
					 					 br(), br(),
					 					 h2("Lab Samples, Gained Flexural Strength:"),
					 					 br(),
					 	...
					 	tabPanel("Flexural Model",
					 					 br(),
					 					 h2("Lab Samples, Flexural Strength Model Trends:"),
					 					 br(),
					 					 ...
					 					 br(), br()
					 					 # h2("Lab Samples, Flexural Strength Gained:"),
					 					 # br(),
