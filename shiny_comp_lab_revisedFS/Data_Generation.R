rm(list = ls())
setwd("E:/R_Projects/stat545_Practces_cms/shiny_comp_lab_revisedFS")
...
library(readxl)
library(forcats)
lab0 <- read_excel("C:/additional/UBC/MENG_Papers/Bryn/LabGroup/Lab_revisedFS_SummaryEliminated.xlsx",
									 sheet = 1)

lab30 <- read_excel("C:/additional/UBC/MENG_Papers/Bryn/LabGroup/Lab_revisedFS_SummaryEliminated.xlsx",
										sheet = 2)

lab90 <- read_excel("C:/additional/UBC/MENG_Papers/Bryn/LabGroup/Lab_revisedFS_SummaryEliminated.xlsx",
										sheet = 3)

lab180 <- read_excel("C:/additional/UBC/MENG_Papers/Bryn/LabGroup/Lab_revisedFS_SummaryEliminated.xlsx",
										 sheet = 4)

lab270 <- read_excel("C:/additional/UBC/MENG_Papers/Bryn/LabGroup/Lab_revisedFS_SummaryEliminated.xlsx",
										 sheet = 5)

lab360 <- read_excel("C:/additional/UBC/MENG_Papers/Bryn/LabGroup/Lab_revisedFS_SummaryEliminated.xlsx",
										 sheet = 6)
